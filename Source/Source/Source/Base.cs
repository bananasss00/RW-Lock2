    ...
    public class Base : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            var rightRect = inRect.RightPart(0.45f);
            {
                ...
                {
                    var section = leftStandard.BeginSection(50);
                    Text.Font = GameFont.Tiny;
                ...
                {
                    var section = leftStandard.BeginSection(95);
                    Text.Font = GameFont.Tiny;
                ...
                {
                    var section = leftStandard.BeginSection(settings.defaultRules.Count * 35 + 50);
                    Text.Font = GameFont.Tiny;
            ...
            }
            {
                ...
                rightStandard.Gap();
                {
                    var section = rightStandard.BeginSection(50);
                    Text.Font = GameFont.Tiny;
                ...
                if (Finder.debug)
                {
                    var section = rightStandard.BeginSection(400);
